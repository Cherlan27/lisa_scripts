...
class make_xrr():
    def __init__(self,
                 data_directory = "K:/SYNCHROTRON/Murphy/2022-10_P08_11014659_giri_hoevelmann_petersdorf/raw_data/raw",
                 use_flatfield = True,
                 use_mask = None,
                 experiment = "nacl",
                 detector = "lambda",
...
xrr_scan = make_xrr()
xrr_scan.scan_numbers = range(1586,1594+1)
xrr_scan.nom_scan_numbers = range(1574,1582+1)
xrr_scan()
xrr_scan.plot_xrr()
